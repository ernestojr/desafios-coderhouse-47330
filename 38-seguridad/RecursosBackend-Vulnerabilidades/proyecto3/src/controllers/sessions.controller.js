...
const login = async (req, res) => {
    ...
    const token = jwt.sign(user.toObject(),'C0DerSecret',{expiresIn:30}); // A05-2021
    res.cookie('CoderCookie',token, { maxAge, httpOnly }).send({status:"success",message:"logged in",payload:user._id})
}
